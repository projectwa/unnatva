...
<head>
    <meta charset="utf-8">
    <title>UNNATVA | Our Impact</title>
...
<body class="act_impact">
        ...
        <div class="imact-banner">
            <div class="row g-4">
                <div class="col-10 mx-auto">
                    <img class="img-fluid p-0 d-block mx-auto" src="<?=S_IMGPATH?>Map.png">
                </div>
            </div>
        </div>
    </div>
    ...
    <!--div class="container-fluid d-block d-md-none bg-light pb-5 px-0 wow fadeIn" data-wow-delay="0.3s">
        <div class="row g-4">
            <div class="col-10 mx-auto">
                <img class="img-fluid d-block mx-auto" src="<?=S_IMGPATH?>impact-mobile-dashboard.png">
            </div>
        </div>
    </div-->
            ...
            <div class="owl-carousel happening-carousel wow fadeInDown" data-wow-delay="0.1s">
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-1.png" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid d-block mx-auto" src="<?=S_IMGPATH?>Swades-Foundation-logo.svg">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-2.png" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>CreditAccess-logo.png" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <!--div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-3.png" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>BCLPL-logo.png" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-4.png" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>Godrej-Boyce-logo.png" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-5.png" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>infra-market-logo.png" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-6.png" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>aak-logo.png" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-7.webp" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>aditya-birla-logo.png" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-8.webp" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>sai-logo.webp" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-9.webp" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>rpg-logo.webp" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-10.webp" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>sun-pharma-logo.webp" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-11.webp" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>tdk-logo.webp" style="border-radius:5px">
                        </div>
                    </div>
                ...
                <div class="testimonial-item p-3 position-relative bg-white">
                    <div class="d-flex align-items-center mb-4 position-relative">
                        <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>ongoing-programmes-12.webp" style="border-radius:5px">
                        <div class="position-absolute bottom-0 start-0 p-3">
                            <img class="img-fluid rounded flex-shrink-0" src="<?= S_IMGPATH ?>mst-logo.png" style="border-radius:5px">
                        </div>
                    </div>
